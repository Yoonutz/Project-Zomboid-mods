...
- [no-verification-scaffolding](no-verification-scaffolding.md) — never write tests/probes to verify a change here; verify by diffing origin/master, then rebase, commit, push
